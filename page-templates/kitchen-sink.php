	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div class="container container-show">
			<div class="row row-show">
				<div class="small-1 columns"><div class="col-show">1</div></div>
				<div class="small-1 columns"><div class="col-show">2</div></div>
				<div class="small-1 columns"><div class="col-show">3</div></div>
				<div class="small-1 columns"><div class="col-show">4</div></div>
				<div class="small-1 columns"><div class="col-show">5</div></div>
				<div class="small-1 columns"><div class="col-show">6</div></div>
				<div class="small-1 columns"><div class="col-show">7</div></div>
				<div class="small-1 columns"><div class="col-show">8</div></div>
				<div class="small-1 columns"><div class="col-show">9</div></div>
				<div class="small-1 columns"><div class="col-show">10</div></div>
				<div class="small-1 columns"><div class="col-show">11</div></div>
				<div class="small-1 columns"><div class="col-show">12</div></div>
			</div>
			<div class="row row-show">
				<div class="main-content"><div class="col-show">content</div></div>
			</div>
		</div>
